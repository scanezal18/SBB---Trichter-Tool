class ZCL_RS_3KATALOGKOMPLEXITAT definition
  public
  final
  create public
...
public section.
  ...
  types TS_KATALOGKOMPLEXITAT type ZRS_3TT_KATKMPLX .
  types:
    tt_katalogkomplexitat TYPE STANDARD TABLE OF ts_katalogkomplexitat WITH DEFAULT KEY .
  types:
    BEGIN OF ts_input_parameters,
        ...
        er_entity                      TYPE ts_katalogkomplexitat,
        et_entityset                   TYPE tt_katalogkomplexitat,
...
private section.
  ...
  constants:
    BEGIN OF mc_error_opt,
      ...
      END OF mc_error_opt,
      mc_key_field TYPE string VALUE 'NUMMER_KOMPLEXITAT'.
  constants:
    BEGIN OF mc_filter_values,
        ...
        to_read                TYPE string VALUE '( NUMMER_KOMPLEXITAT eq `&` )' ##NO_TEXT,
...
CLASS ZCL_RS_3KATALOGKOMPLEXITAT IMPLEMENTATION.
...
*         ...
*----------------------------------------------------------------------*
    DATA(lo_katalog) = NEW zcl_rs_3katalogkomplexitat( is_params ).
...
*----------------------------------------------------------------------*
    get_data( ).
    DATA(lo_response) = NEW zcl_rs_3katalogkomplexitat( gs_params ).
...
*----------------------------------------------------------------------*
    ...
    IF line_exists( lt_keys[ name = mc_key_field ] ) AND
      ...
      DATA(ls_entity) = lt_entity[ nummer_komplexitat = CONV #( lt_keys[ name = mc_key_field ]-value ) ].
