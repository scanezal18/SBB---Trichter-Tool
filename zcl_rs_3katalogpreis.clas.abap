class ZCL_RS_3KATALOGPREIS definition
  public
  final
  create public
...
public section.
  ...
  types TS_KATALOGPREIS type ZRS_3TT_KATPREIS_S .
  types:
    tt_katalogpreis TYPE STANDARD TABLE OF ts_katalogpreis WITH DEFAULT KEY .
  types:
    BEGIN OF ts_input_parameters,
        ...
        er_entity                      TYPE ts_katalogpreis,
        et_entityset                   TYPE tt_katalogpreis,
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
    TYPES: ts_s_katpreis TYPE zrs_3tt_katpreis,
           tt_t_katpreis TYPE STANDARD TABLE OF ts_s_katpreis WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      END OF mc_error_opt,
      mc_key_field TYPE string VALUE 'EINHEIT'.
...
CLASS ZCL_RS_3KATALOGPREIS IMPLEMENTATION.
...
*         ...
*----------------------------------------------------------------------*
    DATA(lo_katalog) = NEW zcl_rs_3katalogpreis( is_params ).
...
*----------------------------------------------------------------------*
    ...
    get_data( ).
    DATA(lo_response) = NEW zcl_rs_3katalogpreis( gs_params ).
...
*----------------------------------------------------------------------*
    ...
    IF line_exists( lt_keys[ name = mc_key_field ] ) AND
      ...
      DATA(ls_entity) = lt_entity[ einheit = CONV #( lt_keys[ name = mc_key_field ]-value ) ].
